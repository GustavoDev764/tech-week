        ...
        return(
            <View style={styles.container}>
                <Header
                    ...
                    />}
                    centerComponent={{ text: 'Inscrição', style: { color: '#fff' } }}
                    rightComponent={{ icon: 'menu', color: '#fff', onPress: this.openMenu, }}
                />
                

                <View style={{marginTop:-1,flexDirection:"row", alignItems:"center",  justifyContent:"space-between", backgroundColor:"#2196f37a"}}>
                    <SearchBar
                    ...
                    <View style={{height:59, marginRight:5, flexDirection:"row", justifyContent:"center", alignItems:"center"}}>
                        <Text onPress={()=>{ this.props.navigation.navigate('Filtro');}} style={{padding:0,}} >
                ...
                <SafeAreaView style={{flex: 1,}}>
                    <ScrollView style={{backgroundColor: '#dae1e8'}} showsVerticalScrollIndicator={false}>
                        <View style={{marginBottom:82}}> 
                            ...
                            image={require('../../../assets/cursos/CursoJavaScript.png')}>
                                ...
                                <View style={{flexDirection:"row"}}>
                                    <Text style={{marginRight:5,}}>Data: 27/11/2017 ate</Text>
                                    
                                    <Text>30/11/2017</Text>
                                </View>
                                <View style={{flexDirection:"row"}}>
                                ...
                                <Text style={{marginBottom: 10, textAlign:"justify"}}>
                                    JavaScript é uma linguagem de programação flexível
                                    e poderosa que é implementada de forma consistente por 
                                    vários navegadores da web. Junto com HTML e CSS.
                            ...
                            containerStyle={{borderRadius:5}}
                            image={require('../../../assets/cursos/CursoPHP7.png')}>
                                ...
                                <Text style={{marginBottom: 10, textAlign:"justify"}}>
                                    ...
                                    usada originalmente apenas para o desenvolvimento de
