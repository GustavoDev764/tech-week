        ...
        return(
            <View style={styles.container}>
                <Header
                    ...
                    />}
                    centerComponent={{ text: 'Meus Cursos', style: { color: '#fff' } }}
                        ...
                        <View style={{marginBottom:82}}> 
                            ...
                            image={require('../../../assets/cursos/CursoJavaScript.png')}>
                                ...
                                <View style={{flexDirection:"row", justifyContent:"space-around"}}>
                                    ...
                                    <Button
                                        icon={<Ionicons name="ios-film" size={30} color="#FFF" style={{marginRight:10,}} />}
                                        buttonStyle={{
                                            borderRadius: 0,
                                            marginLeft: 0,
                                            marginRight: 0,
                            ...
                            image={require('../../../assets/cursos/CursoPHP7.png')}>
                                ...
                                <Button
                                    icon={<Ionicons name="ios-close" size={25} color="#FFF" style={{marginRight:10,}} />}
                                    buttonStyle={{
                                        borderRadius: 0,
                                        marginLeft: 0,
                                        marginRight: 0,
